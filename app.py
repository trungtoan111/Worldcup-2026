...
# ==================================================================
# 1. HỆ THỐNG ĐỒ HỌA HIGH-CONTRAST 4K CHUYÊN NGHIỆP (SIÊU SÁNG RỰC RỠ)
# ==================================================================
...
<style>
    ...
    /* Ép tất cả các văn bản thông thường, nhãn selectbox, chữ markdown sang màu Trắng Tuyết */
    ...
    /* Bảng Banner điều phối chứa cúp vàng chính diện */
    .banner-container {
    ...
    /* Định dạng cho nhánh đấu (Bracket) */
...
# ------------------------------------------------------------------
# BANNER TRUNG TÂM: CÚP VÀNG DANH GIÁ VÀ BANNER CHẠY LIÊN TỤC 4K (ẢNH 1 & 3)
# ------------------------------------------------------------------
...
# ==================================================================
# 2. DATABASE CHUẨN XỊN CHÍNH XÁC ĐẦY ĐỦ ĐÚNG 16 ĐỘI BÓNG (ĐÃ ĐỒNG BỘ)
# ==================================================================
@st.cache_data
def get_teams_data():
    return {
        "Mexico": {
            "bảng": "A", "sơ_đồ": "4-2-3-1", "lối_chơi": "Kiểm soát bóng ngắn, áp đặt thế trận, tấn công biên tốc độ", "ngôi_sao": "Santiago Giménez", "sức_mạnh": "Khá", "hlv": "Javier Aguirre", "logo": "https://flagcdn.com/w80/mx.png",
        ...
        "Nam Phi": {
            "bảng": "A", "sơ_đồ": "4-4-2", "lối_chơi": "Phòng ngự số đông, lùi sâu đội hình, phản công bóng dài", "ngôi_sao": "Percy Tau", "sức_mạnh": "Trung bình", "hlv": "Hugo Broos", "logo": "https://flagcdn.com/w80/za.png",
        ...
        "Hàn Quốc": {
            "bảng": "A", "sơ_đồ": "4-2-3-1", "lối_chơi": "Đá giãn biên, chồng cánh tốc độ cao, áp sát pressing liên tục", "ngôi_sao": "Son Heung-min", "sức_mạnh": "Khá", "hlv": "Hong Myung-bo", "logo": "https://flagcdn.com/w80/kr.png",
        ...
        "CH Séc": {
            "bảng": "A", "sơ_đồ": "3-4-2-1", "lối_chơi": "Kỷ luật thép, va chạm rực lửa, mạnh không chiến và cố định", "ngôi_sao": "Tomas Soucek", "sức_mạnh": "Trung bình", "hlv": "Ivan Hasek", "logo": "https://flagcdn.com/w80/cz.png",
        ...
        "Argentina": {
            "bảng": "A", "sơ_đồ": "4-3-3", "lối_chơi": "Kiểm soát bóng ngắn, luân chuyển bóng nhanh, đột biến trung lộ", "ngôi_sao": "Lionel Messi", "sức_mạnh": "Mạnh", "hlv": "Lionel Scaloni", "logo": "https://flagcdn.com/w80/ar.png",
        ...
        "Algeria": {
            "bảng": "A", "sơ_đồ": "4-2-3-1", "lối_chơi": "Kỹ thuật cá nhân tốt, chuộng đá biên và ban bật ngắn", "ngôi_sao": "Riyad Mahrez", "sức_mạnh": "Khá", "hlv": "Vladimir Petkovic", "logo": "https://flagcdn.com/w80/dz.png",
        ...
        "Mỹ": {
            "bảng": "D", "sơ_đồ": "4-3-3", "lối_chơi": "Pressing tầm cao, chuyển trạng thái nhanh dựa vào tốc độ biên", "ngôi_sao": "Christian Pulisic", "sức_mạnh": "Khá", "hlv": "Mauricio Pochettino", "logo": "https://flagcdn.com/w80/us.png",
...
# KHỞI TẠO LỊCH THI ĐẤU CHUẨN VÀ DIỄN BIẾN TRẬN ĐẤU REAL-TIME
if 'matches' not in st.session_state:
    ...
    for m in raw_schedule:
        matches_db[m[0]] = {
            ...
            "sút_ht": "", "sút_ft": "", "chuyền_ft": "", "góc_ft": "", "thẻ_vàng": "", "thẻ_đỏ": "", "lỗi_ft": ""
        }
...
# BỐ TRÍ KHUNG TABS QUẢN LÝ CHUYÊN NGHIỆP TRÊN DI ĐỘNG
...
# ==================================================================
# TAB 3: DANH SÁCH TOÀN BỘ 16 ĐỘI BÓNG ĐÃ AN TOÀN TUYỆT ĐỐI
# ==================================================================
with tab3:
    st.markdown('<div class="sub-title-custom">CƠ SỞ DỮ LIỆU CHIẾN THUẬT TOÀN GIẢI ĐẤU (16 ĐỘI)</div>', unsafe_allow_html=True)
    team_list = []
